...
public class ProceduralLogicTest {
    ...
    void create() {
        ...
        final InventoryTransferOrder inventoryTransferOrder = new ApplicationService(loadWarehousePort, carrierPort, loadInventoryLpnPort).getInventoryTransferOrder(request);
